...
Five small Blueprints bundled into one file because each is tiny (1-3 routes)
...
(``bp_clusters`` / ``/api/clusters`` — the "Fleet sonar" surface — was
removed 2026-05-19 as part of issue #1716. The Trace Clusters card on
the Usage tab is unrelated: it lives in routes/usage.py as
``/api/sessions/clusters`` and is unaffected.)
