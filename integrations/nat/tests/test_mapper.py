...
# ---------------------------------------------------------------------------
# Type consistency between dict and object steps
# ---------------------------------------------------------------------------


class TestTypeConsistency:
    def test_object_and_dict_both_return_empty_string_for_missing_event_type(self):
        """Both dict and object should return empty string when event_type is absent."""
        ...
        dict_result = mapper._get_event_type({})
        object_result = mapper._get_event_type(FakeStep())

        assert dict_result == object_result, (
            f"Type inconsistency: dict returned {dict_result!r}, "
            f"object returned {object_result!r}"
        )
