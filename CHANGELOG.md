...
- **DeepSeek Harness (`dsh`) is the newest paid runtime. Sessions from github.com/deepseek-ai/deepseek-harness (launched 2026-08-13, ~93k stars in its first day) appear in the fleet, sessions, usage, and Brain views like every other harness — zero config.**
