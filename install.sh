...
echo "  Run with:"
echo ""
echo "    clawmetry --host 0.0.0.0 --port 8900          ← start in foreground (LAN accessible)"
echo "    clawmetry start --host 0.0.0.0 --port 8900    ← run as background service (LAN accessible)""
echo ""
