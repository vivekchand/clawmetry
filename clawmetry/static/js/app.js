...
async function loadAll() {
  try {
    ...
    if (typeof loadPromptErrors === 'function') setTimeout(function(){ loadPromptErrors().catch(function(e){console.warn('prompt errors check failed',e)}); }, 2000);
