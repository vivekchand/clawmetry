...
**Veja seu agente pensar.** Observabilidade em tempo real para **27 runtimes de agentes de IA**: [OpenClaw](https://github.com/openclaw/openclaw), [NVIDIA NemoClaw](https://github.com/NVIDIA/NemoClaw), Claude Code, OpenAI Codex e mais 22. Um único painel para toda a sua frota de agentes.
...
| **Overview**: tokens, sessões, health | **Brain**: fluxo de eventos do agente ao vivo |
