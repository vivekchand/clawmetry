...
## Λειτουργεί με 32 runtimes πρακτόρων
...
|---|---|---|
| Παρακολούθηση αρχείων συνεδρίας (και τα 32 runtimes) | **0**. Ξεχωριστή διεργασία, χωρίς κώδικα ClawMetry στον πράκτορά σας | ενεργό |
