...
**Observa cómo piensa tu agente.** Observabilidad en tiempo real para **26 runtimes de agentes de IA**: [OpenClaw](https://github.com/openclaw/openclaw), [NVIDIA NemoClaw](https://github.com/NVIDIA/NemoClaw), Claude Code, OpenAI Codex y 22 más. Un solo panel para toda tu flota de agentes.
...
Se abre en **http://localhost:8900**. Sin configuración: encuentra los runtimes de agentes
...
| **Cost**: por modelo y sesión | **Approvals**: controla las llamadas a herramientas riesgosas |
