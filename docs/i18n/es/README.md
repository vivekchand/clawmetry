...
**Observa a tu agente pensar.** Observabilidad en tiempo real para **26 runtimes de agentes de IA**: [OpenClaw](https://github.com/openclaw/openclaw), [NVIDIA NemoClaw](https://github.com/NVIDIA/NemoClaw), Claude Code, OpenAI Codex y 22 más. Un solo panel para toda tu flota de agentes.
...
- **Sesiones y transcripciones**: lo que hizo cada agente, turno a turno, con repetición
...
ejecutes `clawmetry connect`. Aun así, la instantánea está cifrada de extremo a extremo
...
| [Aprobaciones y políticas](docs/APPROVALS.md) | Verificación previa a la ejecución, puntuación de riesgo, aprobaciones desde el teléfono |
...
| **Costo**: por modelo y sesión | **Aprobaciones**: filtra llamadas a herramientas riesgosas |
