...
## Działa z 30 środowiskami uruchomieniowymi agentów

**Bezpłatnie w aplikacji open source:** 🦞 **[OpenClaw](https://clawmetry.com/runtimes/openclaw)** · 🟩 **[NVIDIA NemoClaw](https://clawmetry.com/nemoclaw)** · 🪿 **[Goose](https://clawmetry.com/runtimes/goose)**

**W płatnym planie:** ◆ **[Claude Code](https://clawmetry.com/runtimes/claude-code)** · **[Cursor](https://clawmetry.com/runtimes/cursor)** · 🐙 **[GitHub Copilot](https://clawmetry.com/runtimes/copilot)** · ⬡ **[OpenAI Codex](https://clawmetry.com/runtimes/codex)** · ♊ **[Gemini CLI](https://clawmetry.com/runtimes/gemini-cli)** · 💗 **[Lovable](https://clawmetry.com/runtimes/lovable)** · ⠕ **[Replit Agent](https://clawmetry.com/runtimes/replit)** · 🖇 **[Cline](https://clawmetry.com/runtimes/cline)** · 🙌 **[OpenHands](https://clawmetry.com/runtimes/openhands)** · 🧑‍💼 **[OpenWorker](https://clawmetry.com/runtimes/openworker)** · **[opencode](https://clawmetry.com/runtimes/opencode)** · **[Aider](https://clawmetry.com/runtimes/aider)** · 🔗 **[n8n](https://clawmetry.com/runtimes/n8n)** · ◈ **[Qwen Code](https://clawmetry.com/runtimes/qwen-code)** · 🅳 **[Devin](https://clawmetry.com/runtimes/devin)** · 🪐 **[Antigravity](https://clawmetry.com/runtimes/antigravity)** · **[Grok Build](https://clawmetry.com/runtimes/grok)** · 🤖 **[Grok Bot](https://clawmetry.com/runtimes/grok-bot)** · ⚡ **[Hermes](https://clawmetry.com/runtimes/hermes)** · **[Pi](https://clawmetry.com/runtimes/pi)** · **[Deep Agents](https://clawmetry.com/runtimes/deep-agents)** · 🌙 **[Kimi CLI](https://clawmetry.com/runtimes/kimi)** · 🐋 **[DeepSeek Harness](https://clawmetry.com/runtimes/deepseek-harness)** · 🦾 **[Exo](https://clawmetry.com/runtimes/exo)** · **[NanoClaw](https://clawmetry.com/runtimes/nanoclaw)** · **[PicoClaw](https://clawmetry.com/runtimes/picoclaw)** · **[QM](https://clawmetry.com/runtimes/qm)**
...
Zbudowałeś własnego agenta na SDK zamiast korzystać z gotowego środowiska? Interceptor śledzi
również jego wywołania LLM. Zobacz [docs/SDK_TRACKING.md](docs/SDK_TRACKING.md).

## Co otrzymujesz

- **Sesje i transkrypcje**: co robił każdy agent, turę po turze, z powtórką (replay)
...
- **Przepełnienie kontekstu**: wykorzystanie okna liczone osobno dla każdego dostawcy, kompaktowanie kontra wymuszone przepełnienie, plus mapa tego, czego *nie widzimy* dla każdego środowiska uruchomieniowego ([jak to działa](docs/CONTEXT_BLOWOUT.md))
...
- **Zatwierdzenia**: wstrzymywanie ryzykownych wywołań narzędzi *przed* ich wykonaniem i zatwierdzanie z telefonu ([jak to działa](docs/APPROVALS.md))

## Przepełnienie kontekstu i koszt obserwowania

Dwa pytania warte zadania, zanim zaufasz jakiemukolwiek narzędziu porównującemu agentów.

**Jak radzi sobie z przepełnieniem okna kontekstu między różnymi środowiskami uruchomieniowymi?**

Procent wykorzystania jest tak uczciwy, jak wartość, przez którą dzieli. ClawMetry
...
środowisk uruchomieniowych jedną miarką jednego dostawcy. To ma znaczenie: tura na 300K w GPT-5
oceniona wobec 200K Anthropic czyta ">100%, przepełniona", podczas gdy w rzeczywistości jest to 75% z
...
na podstawie domysłu nigdy nie jest renderowany z taką samą wiarygodnością jak ten zbudowany
na podstawie odczytu z tabeli.

ClawMetry może zobaczyć zdarzenia kompaktowania tylko w niektórych środowiskach uruchomieniowych. Dlatego
`GET /api/context-coverage` raportuje, dla każdego środowiska uruchomieniowego, czy **zero oznacza
...
|---|---|---|
| Śledzenie plików sesji (wszystkie 30 środowisk uruchomieniowych) | **0**. Osobny proces, żadnego kodu ClawMetry w twoim agencie | włączone |
| Interceptor HTTP (`CLAWMETRY_INTERCEPT=1`) | **+0,44 ms** na wywołanie LLM, czyli 0,009% wywołania trwającego 5 s | wyłączone |
| Bramka pre-tool hook (ciepła pamięć podręczna) | **+44 ms** na kontrolowane wywołanie narzędzia, ponad 36 ms podłogi interpretera | wyłączone |
| Proxy egzekwujące | **+9,7 ms** na wywołanie LLM | wyłączone |

Koszt hosta demona: **2762 zdarzenia/s** przyjmowania danych, **710 bajtów/zdarzenie** na dysku
(67,7 MB na 100 tys. zdarzeń) oraz **~12% jednego rdzenia** przy stałym obciążeniu na zajętej
instalacji. Ta ostatnia liczba przekracza nasz własny deklarowany budżet 5-10%, więc jest
publikowana jako błąd do naprawienia, a nie pomijana na stronie.
...
a harness działa na Linuksie, macOS i Windows w CI. Dwa wyniki warte poznania: proxy
kosztuje na Windows około siedem razy więcej niż na Linuksie, a demon obecnie
utrzymuje około 12% jednego rdzenia, powyżej naszego własnego budżetu 5-10%. Surowy JSON, metoda
i to, co wciąż niezmierzone, znajdują się w
...
| **Starter** | Każde inne środowisko uruchomieniowe z powyższych, widok floty, synchronizacja w chmurze | 9 USD za węzeł / miesiąc |
| **Pro** | Starter + kontrola i ocena: zatwierdzenia, polityki ryzyka narzędzi, ewaluacje, wykrywanie anomalii, optymalizator kosztów, eksport OTel, dziennik audytu odporny na manipulacje | 19 USD za węzeł / miesiąc |

Plany roczne, wersja Enterprise i aktualne ceny znajdują się na stronie
**[clawmetry.com/pricing](https://clawmetry.com/pricing)**. Klucze licencyjne dla self-hosted
działają bez chmury (`clawmetry license`). Dokładny podział bezpłatne/płatne znajduje się
...
węzeł nie ma klucza, wysyłka jest pomijana, zamiast być wysłana jawnym tekstem, i żadna
odpowiedź serwera nie może tego wyłączyć.

Dwie rzeczy działają domyślnie przed połączeniem, obie opt-out i żadna
nie niesie danych sesji: anonimowy ping instalacyjny i sprawdzanie wersji względem
PyPI. Domyślna instalacja sprawdza też raz twój publiczny adres IP na potrzeby linii
banera startowego. Każdy cel, co niesie i jak to wyłączyć, jest wymienione w
...
który jest dołączany do wheela i serwowany dosłownie, przypięty hashem Subresource
...
Czego to nie dowodzi: my serwujemy stronę, która wczytuje ten plik, więc moglibyśmy
...
który każdy może pobrać. Self-hosting lub pozostanie tylko lokalnie całkowicie
usuwa tę zależność.
...
Wymaga Pythona 3.8+ na macOS, Linuksie lub Windows oraz co najmniej jednego środowiska
uruchomieniowego agenta na tej samej maszynie. Instrukcje Docker: [docs/DOCKER.md](docs/DOCKER.md).
...
| [Przepełnienie kontekstu](docs/CONTEXT_BLOWOUT.md) | Okna dla poszczególnych dostawców, kompaktowanie kontra przepełnienie, pokrycie dla każdego środowiska uruchomieniowego |
| [Narzut wydajnościowy](docs/OVERHEAD.md) | Ile kosztuje instrumentacja, zmierzone, z harnessem do reprodukcji |
| [Uprawnienia (Entitlements)](docs/ENTITLEMENTS.md) | Bezpłatne kontra płatne, macierz poziomów, CLI licencji |
| [Zatwierdzenia i polityki](docs/APPROVALS.md) | Bramkowanie przed wykonaniem, ocena ryzyka, zatwierdzenia z telefonu |
| [OpenTelemetry](docs/OPENTELEMETRY.md) | Eksportuj ślady (traces) gdziekolwiek, przyjmuj OTLP z dowolnego źródła |
...
| [Śledzenie SDK](docs/SDK_TRACKING.md) | Przypisanie kosztów dla agentów, które zbudowałeś sam |
...
Każda liczba poniżej pochodzi z jednej prawdziwej maszyny, w trybie tylko do odczytu, bez niczego spreparowanego.

**Informuje cię, gdy coś jest nie tak, a nie tylko co się wydarzyło.**
...
marnotrawstwa, z rozbiciem na przyczyny.
...
za tym stojącymi i informacją, ile z tego pokrywa już twoja subskrypcja. Poniżej tego,
około 1128 USD/mies. oznaczone jako odzyskiwalne i 17 256 USD/mies. już zaoszczędzone
dzięki ponownemu użyciu pamięci podręcznej (cache).

![Cost: today, this week and this month, with an efficiency grade and itemised savings ideas](https://raw.githubusercontent.com/vivekchand/clawmetry/main/screenshots/cost.png)

**Rysuje, jak wiadomość staje się odpowiedzią.**
Diagram flow na żywo: ty, kanał, którym dotarła wiadomość, gateway, model
...
Co uruchamia, ile kosztuje w ciągu ostatnich 24 godzin i przez cały czas swojego istnienia, kiedy
...
i wywołanie modelu ma swój własny pasek na osi czasu, więc polecenie, które działało
...
Ocena A w tym tygodniu: 54 zadania wróciły czyste, 2 trudniejsze kosztowały 48,57 USD,
a przebiegi z za mało aktywnością, by je ocenić, są pominięte w ocenie, zamiast być
liczone jako sukcesy. Każdy trudny przebieg linkuje do swojego śladu (trace).
...
które wszystkie zostały wywołane proaktywnie, a nie w wyniku przepełnienia, plus wykorzystanie
każdej tury za tym stojącej.

![Context usage: window utilisation per turn, compaction events and tokens reclaimed](https://raw.githubusercontent.com/vivekchand/clawmetry/main/screenshots/context.png)

**Wykrywanie działa bez konfigurowania czegokolwiek.**
Wbudowane detektory są aktywne od instalacji: agent ucichł, kanał telemetrii
przestał działać, skok kosztów, wybuch tokenów, rosnące błędy, skok błędów, próg
...
**Wstrzymywanie ryzykownego wywołania jest opcjonalne (opt-in) i domyślnie wyłączone.**
Rekurencyjne usuwanie, wymuszone push, sudo, sekrety, instalacje pakietów i wywołania
wychodzące — każde otrzymuje regułę, którą możesz włączyć. Dopóki tego nie zrobisz,
ClawMetry obserwuje i niczego nie zmienia. Gdy jedna zostanie włączona, pasujące wywołania
czekają tutaj (lub na twoim telefonie) na zatwierdzenie lub odrzucenie.

![Approvals: protection rules for risky tool calls, all off until you enable them](https://raw.githubusercontent.com/vivekchand/clawmetry/main/screenshots/approvals.png)

Więcej, dla poszczególnych środowisk uruchomieniowych: [docs/RUNTIME_SCREENSHOTS.md](docs/RUNTIME_SCREENSHOTS.md).
