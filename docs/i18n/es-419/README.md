...
**Mira pensar a tu agente.** Observabilidad en tiempo real para **26 runtimes de agentes de IA**: [OpenClaw](https://github.com/openclaw/openclaw), [NVIDIA NemoClaw](https://github.com/NVIDIA/NemoClaw), Claude Code, OpenAI Codex y 22 más. Un solo dashboard para toda tu flota de agentes.
...
Se abre en **http://localhost:8900**. Cero configuración: encuentra los runtimes de agentes que ya tienes, los lee en modo de solo lectura y no cambia nada sobre cómo funcionan.

![Flow Visualization](https://clawmetry.com/screenshots/flow.png)

## Funciona con 26 runtimes de agentes
...
- **Salud y logs**: disco, memoria, tasas de error, límites de tasa, transmisión de logs en vivo
...
| [NemoClaw / OpenShell](docs/NEMOCLAW.md) | Configuraciones sandboxed de NVIDIA NemoClaw |
...
| **Cost**: por modelo y sesión | **Approvals**: controla llamadas a herramientas riesgosas |
